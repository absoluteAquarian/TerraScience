...
namespace TerraScience.Content.Items.Machines {
	public class ReinforcedFurnaceItem : BaseMachineItem<ReinforcedFurnace>, ICraftableMachineItem<CraftableReinforcedFurnaceItem> {
	...
	// This item places the tile, but the tile drops ReinforcedFurnaceItem instead since that item has a maxStack of 1 and needs to store the data in unique stacks
