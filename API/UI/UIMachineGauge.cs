...
namespace TerraScience.API.UI{
	public class UIMachineGauge : UIElement{
		...
		protected override void DrawSelf(SpriteBatch spriteBatch){
			...
			var texture = ModContent.Request<Texture2D>("TerraScience/Content/UI/fluidgauge back").Value;
			...
			var textureFrame = ModContent.Request<Texture2D>("TerraScience/Content/UI/fluidgauge border").Value;
